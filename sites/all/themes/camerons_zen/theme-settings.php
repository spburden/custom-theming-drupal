 ...
 */
function camerons_zen_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['camerons_zen_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('camerons_zen sample setting'),
  '#default_value' => theme_get_setting('camerons_zen_example'),
